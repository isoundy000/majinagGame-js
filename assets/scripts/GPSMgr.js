cc.Class({
    ...
    locateAccurate:function(errorWillCheck){
        ...
        //         jsb.reflection.callStaticMethod('com/tkmj/game/max/gps/GPSSDK','locateAccurateCheck','()V');
        //     }else{
        //         jsb.reflection.callStaticMethod('com/tkmj/game/max/gps/GPSSDK','locateAccurateNotCheck','()V');
        //     }
    ...
    toNetSetting:function(){
        ...
        // if(cc.sys.os==cc.sys.OS_ANDROID){
        //     jsb.reflection.callStaticMethod('com/tkmj/game/max/gps/GPSSDK','toNetSetting','()V');
        // }else if(cc.sys.os==cc.sys.OS_IOS){
    ...
    toGPSSetting:function(){
        ...
        // if(cc.sys.os==cc.sys.OS_ANDROID){
        //     jsb.reflection.callStaticMethod('com/tkmj/game/max/gps/GPSSDK','toGPSSetting','()V');
        // }else if(cc.sys.os==cc.sys.OS_IOS){
    ...
    toGrantSetting:function(){
        ...
        // if(cc.sys.os==cc.sys.OS_ANDROID){
        //     jsb.reflection.callStaticMethod('com/tkmj/game/max/gps/GPSSDK','toGrantSetting','()V');
        // }else if(cc.sys.os==cc.sys.OS_IOS){
    ...
    chkGps:function(){
        ...
        //         self.toNetSetting();
        //     };
        //     cc.vv.alert.show('定位失败!请检查网络设置', toNetSetting, true);
        //     return false;
        // }
