cc.Class({
    ...
    onLoad: function () {
        ...
        if(cc.vv.mjgameNetMgr.conf.type == cc.vv.gameName){
            ...
            this._gameover = this.node.getChildByName("game_over_new");
        }
        else{
    ...
    onGameOver_XZDD: function (overData){
        ...
        for(var i = 0; i < cc.vv.SelectRoom.getRoomPeople(); ++i){
            ...
            for(var k = 0; k < userData.holds.length; ++k){
                ...
                cc.log("wujun ------ pai = ", pai);
                cc.log("wujun -------- cc.vv.mjgameNetMgr.showHunMahjongArray = ", cc.vv.mjgameNetMgr.showHunMahjongArray);
