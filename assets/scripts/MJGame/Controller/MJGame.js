cc.Class({
    ...
    initEventHandlers:function(){
        ...
        this.node.on('gang_notify',function(data){
            ...
            if (getLName == "Dialect") {
                if (gangtype == "angang") {
                    self.setplayEfxAndAudio(localIndex, "play_gang", "angang.mp3");
                }else {
                    self.setplayEfxAndAudio(localIndex, "play_gang", "minggang.mp3");
                }
            }else {
                self.setplayEfxAndAudio(localIndex, "play_gang", "gang.mp3");
            }
    ...
    playTip:function(){
        ...
        var tipNode = this.node.getChildByName("penggangTip");
    ...
    chiOperation: function (data) {
        ...
        this.setplayEfxAndAudio(localIndex, "play_chi", "chi.mp3");
    ...
    pengOperation: function (data) {
        ...
        var localIndex = this.getLocalIndex(seatData.seatindex);
        this.setplayEfxAndAudio(localIndex, "play_peng", "peng.mp3");
    ...
    *******************************************/
    ...
    addOptions: function (actionData) {
        ...
        var playOptionPrefab = cc.vv.prefabMgr.getPrefab("prefabs/MJGame/PlayOption");
