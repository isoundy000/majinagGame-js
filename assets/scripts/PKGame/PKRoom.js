cc.Class({
    ...
    initView: function () {
        ...
        for (var i = 0; i < nSeats; ++i) {
            var pf_rv = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/RoleView");
    ...
    initSingleSeat: function (seat) {
        ...
        if (arr_ChangIndex.indexOf(index) !== -1) {
            this._seats[index].setFoldsPosX(-210);
            this._seats[index].setPaiCountPosX(75);
            this._seats[index].setHoldsPosX(-100);
    ...
    onBtnDissolveClicked: function () {
        cc.vv.alert.show("解散房间不扣元宝，是否确定解散？", function () {
