...
cc.Class({
    ...
    prepareReplay: function (roomInfo, detailOfGame) {
       ...
       // console.log("192",detailOfGame.base_info.conf);
        ...
        for (var i = 0; i < this.seats.length; ++i) {
            ...
            seatData.wangangs = [];
            seatData.folds = [];
            seatData.bright = [];//锟斤拷锟斤拷锟斤拷锟斤拷锟�
            seatData.secret = [];//锟斤拷锟桔碉拷锟斤拷
            seatData.operation = [];//锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
