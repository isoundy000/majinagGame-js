cc.Class({
    ...
    onLoad: function () {
        ...
        this.addComponent("PKTimePointer");
        this.addComponent("PKGameResult");
        // this.addComponent("PKGameOver");
        this.addComponent("Chat");
        this.addComponent("PKFolds");
        this.addComponent("PKReplayCtrl");
        this.addComponent("PopupMgr");
        //this.addComponent("HuanSanZhang");
        this.addComponent("ReConnect");
        this.addComponent("Voice");
        this.addComponent("UserInfoShow");
        this.addComponent("PKrun");
    ...
    initBottomCards: function (cards) {
        ...
        for (let i = 0; i < card_len; ++i) {
            let prefab = cc.vv.prefabMgr.getPrefab('prefabs/PKGame/MyPK');
...
//
    ...
    onGameBeign: function () {
        ...
        var seats = cc.vv.pkgameNetMgr.seats;
        var seatData = seats[cc.vv.pkgameNetMgr.seatIndex];
        this.initCardTag();
        ...
        if (cc.vv.pkgameNetMgr.isSync) {
            cc.find('Canvas/infobar/times').getComponent(cc.Label).string = cc.vv.pkgameNetMgr.beishu;
        } else {
    ...
    initEventHandlers: function () {
        ...
        this.node.on('game_chupai', function (data) {
            ...
            if (localindex === 0) {
                ...
                //     self._hintPaiArr = cc.vv.ddzpkmgr.getActivetips(holds);
                // } else {
                    self._hintPaiArr = cc.vv.ddzpkmgr.getTipsCardsList(lastpai, holds);
                // }
    ...
    checkPK: function () {
        ...
        console.log(cc.vv.ddzpkmgr.isLegality(tmpID));
        if (cc.vv.ddzpkmgr.isLegality(tmpID)) {
    ...
    mjClickedReturn: function (event, isStart) {
        ...
        if (cc.vv.PKReplayMgr.isReplay() == true) {
    ...
    shoot: function () {
        ...
        if (cc.vv.ddzpkmgr.compare(lastpai, myjdarr) === false) {
    ...
    start: function () {
        ...
        if (LastPai !== undefined) {
            if (mySeat.holds !== undefined) {
                ...
                // if (cc.vv.gameNetMgr.chupai_PK_last[0] === 54) {
                //     this._hintPaiArr = cc.vv.ddzpkmgr.getActivetips(myholds);
                // }
                this._hintPaiArr = cc.vv.ddzpkmgr.getTipsCardsList(lastpai, myholds);
    ...
    /**********动画********/
    play_feiji: function () {
        var ani_feiji = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/ani_feiji");
    ...
    play_roket: function () {
        var ani_roket = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/ani_roket");
    ...
    play_shunzi: function () {
        ...
        var ani_shunzi = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/ani_shunzi");
    ...
    play_liandui: function () {
        ...
        var ani_shunzi = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/ani_liandui");
        var tmp_shunzi = cc.instantiate(ani_shunzi);
        this.gameRoot.addChild(tmp_shunzi);
        var self = this;
        for (let i = 0; i < tmp_shunzi.childrenCount; i++) {
    ...
    play_chuntian: function (ischuntian) {
        ...
        var ani_shunzi = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/ani_chuntian");
        var tmp_shunzi = cc.instantiate(ani_shunzi);
        if (ischuntian) {
        ...
        tmp_ani.on('finished', function () {
            setTimeout(function () {
                tmp_shunzi.destroy();
                self.node.getChildByName('game_result').active = true;
            }.bind(self),10);
        })
    ...
    play_shibai: function () {
        var ani_shunzi = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/ani_shibai");
        var tmp_shunzi = cc.instantiate(ani_shunzi);
        this.gameRoot.addChild(tmp_shunzi);
    ...
    play_shengli: function () {
        ...
        var ani_shunzi = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/ani_shengli");
        var tmp_shunzi = cc.instantiate(ani_shunzi);
        this.gameRoot.addChild(tmp_shunzi);
        var tmp_ani = tmp_shunzi.children[0].getComponent(cc.Animation);
        var self = this;
    ...
    play_bomb: function (pos) {
        var ani_shunzi = cc.vv.prefabMgr.getPrefab("prefabs/PKGame/ani_bomb");
        var tmp_shunzi = cc.instantiate(ani_shunzi);
        this.gameRoot.addChild(tmp_shunzi);
        var tmp_ani = tmp_shunzi.getComponent(cc.Animation);
        var self = this;
    ...
    *******************************************/
    ...
    initClubFriend: function () {
        ...
        var btnClubFriend = this.node.getChildByName("btnClubFriend");
        ...
        if(cc.vv.PKReplayMgr.isReplay()){
            btnClubFriend.active = false;
            var btnRefresh = this.node.getChildByName("btnRefresh");
