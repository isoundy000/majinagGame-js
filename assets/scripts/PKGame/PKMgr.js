...
cc.Class({
    ...
    getAudioURLByMJID: function (pai) {
        // var realId = this.getPKrealNum(pai[0]);
        //
        // if (pai.length === 1) {
        //     realId = 'b_' + realId
        // } else if (pai.length === 2) {
        //     if (realId === 52 || realId == 53) {
        //         realId = 'kingbomb'
        //     } else if (realId === 3) {
        //
        //         if (this.isSpeakDouble3(pai)) {
        //             realId = 'double3'
        //         } else realId = 'b_p' + realId;
        //
        //     } else realId = 'b_p' + realId;
        // } else {
        //     realId = 'bomb'
    ...
    // 0,1,2,3,4,5 黑桃,红桃,草花,方片,小王，大王
    //b-black_0  b-orange_0  b-red_0  //b-bigtag_0 方片  草花  红桃  黑桃
    getSpriteFrameByMJID: function (pre, mjid) {
        ...
        if (huase === 0) {
            var rethua = this.myselftAtlas.getSpriteFrame('b-bigtag_3')
            var rethua2 = rethua
            tag = "b-black_"

        } else if (huase === 1) {
            var rethua = this.myselftAtlas.getSpriteFrame('b-bigtag_2')
            var rethua2 = rethua
            tag = "b-red_"
        } else if (huase === 2) {
            var rethua = this.myselftAtlas.getSpriteFrame('b-bigtag_1')
            var rethua2 = rethua
            tag = "b-black_"
        } else if (huase === 3) {
            var rethua = this.myselftAtlas.getSpriteFrame('b-bigtag_0')
            var rethua2 = rethua
            tag = "b-orange_"
        } else if (huase === 4) {
            tag = "b-smalltag_4"
            var rethua = this.myselftAtlas.getSpriteFrame('b-smalltag_4')
            var rethua2 = this.myselftAtlas.getSpriteFrame('b-bigtag_4')
        } else if (huase === 5) {
            tag = "b-smalltag_5"
            var rethua = this.myselftAtlas.getSpriteFrame('b-smalltag_5');
            var rethua2 = this.myselftAtlas.getSpriteFrame('b-bigtag_5');
        }
        ...
        retFrame.tmpBG = this.myselftAtlas.getSpriteFrame('b-bg');
        retFrame.tmpBack = this.myselftAtlas.getSpriteFrame('b-poker_back');
        return retFrame;
