cc.redPackShareImgUrl='http://update.ydjoy.com/guoyaomj/public/';
cc.guest_ip = "http://123.207.40.180";
cc.formal_ip = "http://guoyaomj.ydjoy.com";
cc.port = "7940";

cc.guest_url = cc.guest_ip + ":" + cc.port;//测试服
cc.formal_url = cc.formal_ip + ":" + cc.port;//正式服

 var URL = cc.guest_url;
//  var URL =cc.formal_url;

cc.client_version = 1.0;
cc.VERSION = 20161227;
var HTTP = cc.Class({
